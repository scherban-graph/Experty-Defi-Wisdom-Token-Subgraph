...
export class WisdomToken extends ethereum.SmartContract {
  static bind(address: Address): WisdomToken {
    return new WisdomToken("WisdomToken", address);
  }
...
export class AliveCall extends ethereum.Call {
  get inputs(): AliveCall__Inputs {
    return new AliveCall__Inputs(this);
  }

  get outputs(): AliveCall__Outputs {
    return new AliveCall__Outputs(this);
  }
}

export class AliveCall__Inputs {
  _call: AliveCall;

  constructor(call: AliveCall) {
    this._call = call;
  }
...
export class AliveCall__Outputs {
  _call: AliveCall;
